...
const char * const g_FRC_2019_Controls_Events[] = 
{
...
class FRC_2019_Goals_Impl : public AtomicGoal
{
	private:
		...
		private:
			FRC_2019_Goals_Impl *m_Parent;
		public:
			goal_clock(FRC_2019_Goals_Impl *Parent)	: m_Parent(Parent) {	m_Status=eInactive;	}
		...
		{
		public:
			MoveForward(FRC_2019_Goals_Impl *Parent)	: SetUpProps(Parent) {	m_Status=eActive;	}
		...
		{
		public:
			MoveSideways(FRC_2019_Goals_Impl *Parent)	: SetUpProps(Parent) {	m_Status=eActive;	}
			virtual void Activate()
			{
				AddSubgoal(new Goal_Wait(0.500));  //Testing
